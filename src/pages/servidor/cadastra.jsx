    ...
    render() {
        ...
        return (
            <Panel titulo="Cadastro de Servidores" footer={this.footer()}>
                <div className="row">
                    <InputLabel erros={this.props.erros} change={this.props.change} label="Nome" name="nome" estilo="col-md-5" value={this.props.servidor.nome} maxLength="25" />
                    <InputLabel erros={this.props.erros} label="IP" estilo="col-md" name="ip" change={this.props.change} value={this.props.servidor.ip} />
                    ...
                    <InputLabel erros={this.props.erros} label="Descrição" estilo="col-md-6" name="descricao" change={this.props.change} value={this.props.servidor.descricao} />
                    <InputLabel erros={this.props.erros} label="Função" estilo="col-md-6" name="funcionalidade" change={this.props.change} value={this.props.servidor.funcionalidade} />
                    ...
                    <InputLabel erros={this.props.erros} label="Nº de Processadores" estilo="col-md-4" name="qtdProcessador" change={this.props.change} value={this.props.servidor.qtdProcessador} />
                    <InputLabel erros={this.props.erros} control="hd" label="HD" estilo="col-md" name="hd.quantidadeHD" change={this.props.change} value={this.props.servidor.hd.quantidadeHD} />
                    ...
                    <InputLabel erros={this.props.erros} label="Memória" control="memoria" estilo="col-md" name="memoria.quantidadeMemoria" change={this.props.change} value={this.props.servidor.memoria.quantidadeMemoria} />
